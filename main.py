...
"""
    await m.reply(
        ...
        buttons=[
            [
                Button.url("Channel 1 📢", url="https://t.me/TeraboxDownloaderINDIA"),
                Button.url("Channel 2 📢", url="https://t.me/+L7tcuoCsTaMxZWVl"),
            ],
            [
                Button.url("Group 💬", url="https://t.me/+cySPj7iDogFkMzc1"),
